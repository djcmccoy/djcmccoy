...
$(document).ready(function() {
    ...
    $('.slider-article').each(function() {
        ...
        var halfSliderProCaption = new Swiper('.slider-article-details', {
            slidesPerView: 1,
            loop: true,
			fadeEffect: {
                crossFade: true
        ...
        var halfSliderProImage = new Swiper('.slider-article', {
            slidesPerView: 1,
            loop: true,
		    speed: 1200,
            simulateTouch: false,
        ...
        halfSliderProCaption.controller.control = halfSliderProImage;
        halfSliderProImage.controller.control = halfSliderProCaption;
	});	
